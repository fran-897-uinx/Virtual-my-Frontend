    ...
    <>
      ...
      <main className="min-h-screen pt-24 pb-16 bg-gray-950 text-green-400">
        <section className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          {loading ? (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 auto-rows-[180px] sm:auto-rows-[220px] md:auto-rows-[260px] lg:auto-rows-[280px]">
              {Array.from({ length: 8 }).map((_, idx) => (
                <div key={idx} className={`relative ${sizeMapMd[idx % sizeMapMd.length]}`}>
                  <div className="w-full h-full bg-gray-900 border border-green-500/10 rounded-none animate-pulse flex items-center justify-center">
